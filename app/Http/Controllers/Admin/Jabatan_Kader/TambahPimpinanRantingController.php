...
class TambahPimpinanRantingController extends Controller
{
  ...
  public function destroy(Request $request, Kader $kader, $id)
  {
    ...
    return redirect('/jabatan/kader/cabang/' . $id)->with('message_pimp_ranting', 'Berhasil menghapus ' . $kader->nama . ' sebagai ' . $request->jabatan . '.');
  }
}
