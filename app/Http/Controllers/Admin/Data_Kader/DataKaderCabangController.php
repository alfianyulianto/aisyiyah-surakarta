...
class DataKaderCabangController extends Controller
{
  /**
  ...
  public function index()
  {
    ...
    foreach ($user as $u) {
      $cek_kader = Kader::where('cabang_id_cabang', Auth::user()->admin_at)->where('nik', $u->kader_nik)->first();
      if ($cek_kader) {
  ...
  public function store(Request $request)
  {
    ...
    $validatedData = [
      ...
      'nama' => $request->nama,
      'cabang_id_cabang' => Auth::user()->admin_at,
    ...
    return redirect('/data/kader/cabang')->with('message_kader', 'Data ' . $request->nama . ' berhasil ditambahkan sebagai kader.');
  }
  ...
  public function show($id)
  {
    ...
    // cek jika kader bukan dari cabang 
    $kader = Kader::where('nik', $id)->where('cabang_id_cabang', Auth::user()->admin_at)->first();
    if ($kader) {
      return abort(403);
    }
  ...
  public function update(Request $request, $id)
  {
    ...
    return redirect('/data/kader/cabang')->with('message_kader', 'Data kader ' . $request->nama . ' berhasil diubah.');
  }
