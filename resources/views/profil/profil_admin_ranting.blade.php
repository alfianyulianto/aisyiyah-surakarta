                      ...
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="nama" id="nama"
                            placeholder="Nama Lengkap (cnth:Siti Aisyiyah)"
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="ranting_id_ranting" id="ranting_id_ranting"
                            value="{{ old('ranting_id_ranting', $ranting->nama_ranting) }}" readonly>
                      ...
                      <div class="col-lg-12">
                        <div class="mb-3">
                          ...
                          <input type="email" class="form-control" name="email" id="email"
                            placeholder="Email (cnth:sitiaisyiyah@gmail.com)" value="{{ old('email', $kader->email) }}">
                          @error('email')
                            <div class="error-message">
                              {{ $message }}
                            </div>
