...
@section('content')
  <section class="section">
    <div class="section-header">
      <h1>Upload SK Pimpinan Cabang {{ $nama_cabang }} Kota Surakarta </h1>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              @if (session('message_sk_pimp_cabang'))
                <div class="alert alert-success alert-dismissible show fade">
                  <div class="alert-body">
                    <button class="close" data-dismiss="alert">
                      <span>&times;</span>
                    </button>
                    {{ session('message_sk_pimp_cabang') }}
                  </div>
                </div>
              @endif
              <div class="row">
                <div class="col-lg-6">
                  <form action="/upload/sk/pimpinan/cabang/{{ $id_cabang }}" method="post"
                    ...
                    <div class="d-flex justify-content-end mt-2">
                      <button type="submit" class="btn btn-primary">Upload SK Pimpinan Cabang</button>
                    </div>
                  </form>
                </div>
                <div class="col-lg-6">
                      ...
                      <tbody>
                        @foreach ($sk_pimpinan as $s)
                          <tr>
                            ...
                            <td>
                              <a href="/sk/pimpinan/cabang/{{ $s->id_sk_pimpinan }}" class="text-decoration-none">
