...
@section('content')
  <section class="section">
    <div class="section-header">
      <h1>Update Data Kader 'Aisyiyah Surakarta'</h1>
    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-lg-10">
                  <form action="/data/kader/daerah/{{ $kader->nik }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row">
                      <div class="col-lg-6">
                      ...
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="nama" id="nama"
                            placeholder="Nama Lengkap (cnth:Siti Aisyiyah)" value="{{ old('nama', $kader->nama) }}">
                          @error('nama')
                            <div class="error-message">
                              {{ $message }}
                            </div>
