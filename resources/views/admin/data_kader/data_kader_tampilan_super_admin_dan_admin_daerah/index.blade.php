...
@section('content')
  <section class="section">
    <div class="section-header">
      <h1>Data Kader 'Aisyiyah Kota Surakarta</h1>
    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              @endif
              <a href="/data/kader/daerah/create" class="btn btn-icon icon-left btn-primary mb-3"><i
                  ...
                  <tbody>
                    @foreach ($kader as $k)
                      <tr>
                        ...
                        <td>{{ $k->no_ponsel }}</td>
                        <td>
                          <a href="/data/kader/daerah/{{ $k->nik }}" class="btn btn-icon icon-left btn-primary"
                            target="_blank"><i class="far fa-eye"></i>
                            Detail</a>
                          <a href="/data/kader/daerah/{{ $k->nik }}/edit"
