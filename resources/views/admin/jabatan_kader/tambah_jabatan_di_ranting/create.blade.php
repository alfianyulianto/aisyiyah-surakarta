...
@section('content')
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
          <div class="card">
            <div class="card-body">
              @if (session('message_pimp_ranting'))
                <div class="alert alert-success alert-dismissible show fade">
                  <div class="alert-body">
                    <marquee direction="left">{{ session('message_pimp_ranting') }}</marquee>
                  </div>
                </div>
              @endif
              @if (session('message_delete_pimp_ranting'))
                <div class="alert alert-danger alert-dismissible show fade">
                  <div class="alert-body">
                    <marquee direction="left">{{ session('message_delete_pimp_ranting') }}</marquee>
                  </div>
                </div>
              @endif
              <form action="/jabatan/kader/ranting/{{ $id_ranting }}" method="post">
                @csrf
                <div class="row">
                  <div class="col-lg-12">
                    <div class="row">
  ...
  <script>
    $("#periode").on("change", function() {
      ...
      $.ajax({
        type: "get",
        url: "/get/jabatan/kader/ranting/" + id_periode + "/" + <?= json_encode($id_ranting) ?>,
        dataType: "json",
