...
@section('content')
  <section class="section">
    <div class="section-header">
      <h1>Edit Ortom Yang Di Ikuti</h1>
    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-lg-8">
                  <form action="/admin/ortom/{{ $kader_ortom->id_kader_has_ortom }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="id_kader_has_ortom" id="id_kader_has_ortom"
                            value="{{ old('id_kader_has_ortom', $kader_ortom->id_kader_has_ortom) }}" readonly>
                      ...
                      <div class="col-lg-12">
                        <div class="mb-3">
                          ...
                          <select class="form-control form-control-lg selectric" id="ortom_id_ortom"
                            name="ortom_id_ortom">
                            @if (old('ortom_id_ortom', $kader_ortom->ortom_id_ortom))
                              <option disabled>-- Pilih Ortom --</option>
                              @foreach ($ortom as $o)
                                @if (old('ortom_id_ortom', $kader_ortom->ortom_id_ortom) == $o->id_ortom)
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="mb-3">
                          ...
                          <textarea id="summernote" name="ortom_uraian" style="height: 1876px">{!! old('ortom_uraian', $kader_ortom->ortom_uraian) !!}</textarea>
                          @error('ortom_uraian')
                            <div class="error-message">
                              {{ $message }}
                            </div>
